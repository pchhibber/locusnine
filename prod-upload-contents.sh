...
# echo "enabling preview mode for cloudfront to have the invalidation creation facility"
aws configure set preview.cloudfront true

# echo retrieving cdn distribution id
cdnDistributionId=E3ST3UKVZIILR5

# echo "invalidating cloudfront caches for distribution $cdnDistributionId"
